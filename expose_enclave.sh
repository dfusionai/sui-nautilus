...
sleep 5
# Secrets-block
SECRET_JSON=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:us-east-1:227314482053:secret:stage-nautilus-azure-gZgwRa --region us-east-1 | jq -r .SecretString)
