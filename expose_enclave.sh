...
sleep 5
# Secrets-block
SECRET_JSON=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:us-east-1:227314482053:secret:sui-nautilus-497578-a19Fca --region us-east-1 | jq -r .SecretString)
