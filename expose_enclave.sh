...
sleep 5
# Secrets-block
SECRET_JSON=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:us-east-1:795254591587:secret:dfusion-test-UqTAQZ --region us-east-1 | jq -r .SecretString)
